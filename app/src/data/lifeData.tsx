...
export const lifePageData = {
  title: "My Life",
  description: "I'm not going to lie I do love to work. Unless it's writing documentation then you'd rather see me at the DMV. However I do think that taking some time aside to prioritize getting outdoors and hanging out with family and friends is what this is all about.",
  backgroundImage: backgroundImage,

  hobbies: [
    {
      name: "Skiing & Snowboarding",
      description: "One of the main reasons why I moved out of Kansas was to be able to hit the snow on an actual hill.",
      image: '/images/life/hobbies/skiing.jpg',
      icon: "ski"
    },
    {
      name: "Running",
      description: "I moved to Colorado for the winters, and I've ended up staying for the summers. I love running here, so many trails with great weather. I've made a lot of friends within the running community here, and for that I'm grateful. ",
      image: '/images/life/hobbies/running.jpg',
      icon: "run"
    },
    {
      name: "Backpacking",
      description: "Family thinks I'm crazy for it, they just don't understand the joy of eating gushers on day 3 mile 40.",
  ...
  galleryItems: [
    ...
    },
    {
      ...
      caption: "Me with my old co-workers from Cerner finishing the 4 Loop Pass",
