...
const EducationPage: FC = memo(() => {
  ...
  return (
    ...
    >
        ...
        <div className="z-10 w-full max-w-screen-xl px-4 mx-auto">
          <div className="rounded-xl bg-forest-green/50 p-8 text-left shadow-xl backdrop-blur-sm border border-sage-green/20 max-w-3xl">
            ...
            <div className="animate-fadeIn mt-6 text-stone-100">
              <p className="mb-4">
                I spent four years at Wichita State University where I
                discovered my passion for web development.
              </p>
              <p>
                My team and I won the Koch Innovation Challenge by creating the
                most intuitive website, which sparked my journey into full-stack
      ...
      <main
        className={`animate-fadeIn ${isLoaded ? "opacity-100" : "opacity-0"}`}
      >
        <div className="min-h-screen bg-white pb-20">
          <div
            id="education-details"
            className="container mx-auto px-4 sm:px-6 lg:px-8 pt-16"
          >
                ...
                <div className="bg-white rounded-lg p-6">
                  <div className="flex flex-col md:flex-row gap-8 items-center mb-8">
                    ...
                    <div>
                      ...
                      <p className="mt-4 text-stone-700">
                        Earned a degree in Management Information Systems at
                        Wichita State University. During my time at Wichita
                        State, I worked with 3 other teammates to develop an
                        innovative web application that earned us the top spot
                        in the Koch Innovation Challenge.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="mt-8 pt-8 border-t border-sage-green/20">
                    <h3 className="text-xl font-bold text-forest-green mb-4">
                      Koch Innovation Challenge Winner
                    </h3>
                    <p className="text-stone-700 mb-4">
                      Our project focused on creating an intuitive user
                      experience while solving a real-world problem. This
                      experience was pivotal in shaping my approach to
                      development, emphasizing the importance of both technical
