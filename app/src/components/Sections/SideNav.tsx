...
export const SideNav: FC = memo(() => {
  ...
  const isPageActive = (href: string): boolean => {
    ...
    if (
      href === "/site-info" &&
      (currentPage === "/site-info" || currentPage === "/info")
    ) {
      return true;
    }
    ...
    <>
      ...
      <nav
        className={`
                    ${
                      isMobile
                        ? `fixed left-0 top-0 h-full w-64 bg-white/95 shadow-lg z-40 transform transition-transform duration-300 ease-in-out ${
            ...
            {sections.map((section) => (
              <a
                ...
                className={`
                                    ...
                                    ${
                                      isMobile
                                        ? "text-base p-2 flex items-center rounded-lg"
                                        : "text-xl p-3 font-semibold"
                                    }
                                    ${
