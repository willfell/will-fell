...
const InfoPage: FC = memo(() => {
  ...
  const [lastDeployment, setLastDeployment] = useState({ date: '', status: 'success' });
      ...
      >
        ...
        <div className="max-w-screen-xl mx-auto">
          ...
          <section id="project-overview" className="mb-16 grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="animate-on-scroll flex flex-col justify-center" style={{ transitionDelay: '200ms' }}>
              <div className="relative h-max group mb-4">
                <h2 className="text-2xl font-bold text-forest-green">Personal Portfolio Website</h2>
              ...
              <div className="mt-6 bg-forest-green/10 backdrop-blur-sm border border-sage-green/30 rounded-lg p-4 transition-all duration-300 hover:bg-forest-green/20">
                ...
                {isLoading ? (
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm text-stone-black">Fetching deployment info...</span>
                  </div>
                ) : (
                  <div className="flex items-center space-x-2">
                    <div className={`h-3 w-3 rounded-full ${lastDeployment.status === 'success' ? 'bg-green-500' : 'bg-red-500'}`}></div>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-lg p-8 border border-sage-green/30 shadow-lg">
              ...
              <div className="relative">
                ...
                <div className="space-y-8 relative">
                  ...
                  <div className="animate-on-scroll flex flex-col md:flex-row gap-4 relative" style={{ transitionDelay: '300ms' }}>
                    ...
                    <div className="ml-0 md:ml-6 bg-forest-green/10 rounded-lg p-5 shadow-sm transition-all duration-300 hover:shadow-md hover:bg-forest-green/20 flex-1">
                      <h4 className="font-semibold text-forest-green mb-2">Infrastructure as Code</h4>
                      <p className="text-sm text-stone-black">
                        All AWS infrastructure is defined and managed using Terraform, making it reproducible and maintainable.
                        This includes S3 buckets, CloudFront distribution, IAM policies, and route configurations.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="animate-on-scroll flex flex-col md:flex-row gap-4 relative" style={{ transitionDelay: '400ms' }}>
                    ...
                    <div className="ml-0 md:ml-6 bg-forest-green/10 rounded-lg p-5 shadow-sm transition-all duration-300 hover:shadow-md hover:bg-forest-green/20 flex-1">
                      <h4 className="font-semibold text-forest-green mb-2">Deployment & Monitoring</h4>
                      <p className="text-sm text-stone-black">
                        Upon successful testing, the site is deployed to AWS S3 and distributed via CloudFront CDN.
                        Monitoring is in place to track performance metrics and automatically detect any issues.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="animate-on-scroll mt-10 p-6 border-l-4 border-earth-tan bg-earth-tan/10 rounded-r-lg relative" style={{ transitionDelay: '500ms' }}>
                ...
                <p className="text-stone-black relative">
                  ...
                  and minimizes the potential for human error, while maintaining high performance and security standards.
                </p>
              </div>
            </div>
          </section>
