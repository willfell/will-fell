...
export const initLoadAnimations = () => {
  const animateLoadElements =
    document.querySelectorAll<HTMLElement>(".animate-on-load");
...
export const initScrollAnimations = () => {
  ...
  const modalContent = document.querySelectorAll<HTMLElement>(
    ".project-modal .animate-on-scroll",
  );
...
export const applyModalAnimations = () => {
  const modalElements = document.querySelectorAll<HTMLElement>(
    ".project-modal .animate-on-scroll, .modal-content > *",
  );
